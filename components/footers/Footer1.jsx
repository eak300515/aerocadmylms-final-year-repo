              ...
              <div className="col-12">
                <div className="footer-body-wrap flex justify-between">
                  ...
                  >
                    <div className="footer-logo">
                      <Link href={`/`}>
                        <Image
                          alt=""
                          src="/images/logo/aerocadmy-white.svg"
                          width={123}
                          height={36}
                        />
                      </Link>
                    ...
                    <ul className="address">
                      ...
                      <li className="flex gap-10 items-center">
                        ...
                        <p>supportflight@aerocadmy.com</p>
                      </li>
                      <li className="flex gap-10 items-center">
                        <div className="icon">
                  ...
                  >
                    ...
                    <p>
                      2000+ Our students are subscribed with us Around the World. Don’t
            ...
            <div className="row">
              <div className="col-12">
                <div className="footer-bottom-wrap flex justify-center items-center">
                  <p>©&nbsp;2025&nbsp;aerocadmy. All Rights Reserved</p>
                </div>
              </div>
            </div>
          </div>
