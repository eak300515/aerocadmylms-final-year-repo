              ...
              <ul>
                <li>
                  <div className="selling-course-item item my-20 ptable-20 border-bottom">
                    ...
                    <div>
                      <p className="fs-15 fw-5">Rs.2,25,478</p>
                    </div>
                    <div>
                ...
                <li>
                  <div className="selling-course-item item my-20 ptable-20 border-bottom">
                    ...
                    <div>
                      <p className="fs-15 fw-5">Rs.1,25,478</p>
                    </div>
                    <div>
                      <div className="selling-course-btn btn-style-2">
                        <a href="#" className="btn-edit btn">
                ...
                <li>
                  <div className="selling-course-item item my-20 ptable-20 border-bottom">
                    <div className="image">
                      <Image
                        className="lazyload"
                        src="/images/courses/course-06.jpg"
                        data-=""
                        alt=""
                        width={520}
                        height={381}
                    ...
                    <div>
                      <p className="fs-15 fw-5">Rs.1,10,478</p>
                    </div>
                    <div>
                      <div className="selling-course-btn btn-style-2">
                        <a href="#" className="btn-edit btn">
                ...
                <li>
                  <div className="selling-course-item item ptable-20 border-bottom">
                    <div className="image">
                      <Image
                        className="lazyload"
                        src="/images/courses/course-08.jpg"
                        data-=""
                        alt=""
                        width={520}
                        height={381}
                    ...
                    <div>
                      <p className="fs-15 fw-5">Rs.3,25,478</p>
                    </div>
                    <div>
                      <div className="selling-course-btn btn-style-2">
                        <a href="#" className="btn-edit btn">
