          ...
          <div className="event-single-inner">
            <div className="event-decs">
              ...
              <p className="text-1 fs-15">
                Join us for an immersive exploration into cutting-edge drone
                technologies, autonomous systems, and cybersecurity innovations.
                Engage with industry leaders, participate in hands-on demos, and
                discover how aerial tech is reshaping the future of flight and
                data security.
              </p>
              <p className="text-2 fs-15">
                Discover the future of aerial innovation at our exclusive
                summit, where drone engineering meets real-world application.
                From precision piloting to AI-powered flight systems, experience
                the breakthroughs driving the next frontier of aerospace
                technology.
              </p>
            </div>
            <div className="event-content">
              ...
              <ul>
                ...
                <li className="fs-15">
                  It is recommended that you download the Drone Simulator
                </li>
              </ul>
            </div>
                      ...
                      >
                        <div className="speaker-img">
                          <Image
                            ...
                            data-src="/images/avatar/user-01.webp"
                            alt=""
                            src="/images/avatar/user-01.webp"
                            width={520}
                            height={521}
                          />
                        </div>
                    ...
                    >
                      ...
                      >
                        <div className="speaker-img">
                          <Image
                            className="ls-is-cached lazyloaded"
                            data-src="/images/avatar/user-02.jpeg"
                            alt=""
                            src="/images/avatar/user-02.jpeg"
                            width={520}
                            height={521}
                          />
                        </div>
                    ...
                    >
                      ...
                      >
                        <div className="speaker-img">
                          <Image
                            className="ls-is-cached lazyloaded"
                            data-src="/images/avatar/user-03.jpg"
                            alt=""
                            src="/images/avatar/user-03.jpg"
                            width={520}
                            height={521}
                          />
                        </div>
