            ...
            <div className="box-img">
              ...
              <div className="wrap-images">
                <div className="image">
                  <Image
                    className="lazyload"
                    data-src="/images/section/about-01.avif"
                    alt=""
            ...
            <div className="content-wrap">
              <div className="box-sub-tag wow fadeInUp" data-wow-delay="0.1s">
                ...
                <div className="sub-tag-title">
                  <p>Flexible Drone Learning, Backed by Expert Support</p>
                </div>
              </div>
              <h2
              ...
              <p className="text-content wow fadeInUp" data-wow-delay="0.3s">
                Master every aspect of drone technology — from basic piloting to
                advanced flight systems. Aerocadmy empowers you to lead
                confidently across the entire flight frontier.
              </p>
