          ...
          <div className="col-md-6">
            <div className="content-left">
              ...
              <p className="fs-15 wow fadeInUp" data-wow-delay="0.3s">
                With the aerocadmy App, you can learn no matter where you are.
                <br />
                Download now to learn and fly wherever and whenever.
              </p>
              <ul
          ...
          <div className="col-md-6">
            <div className="image-right">
              <div className="img1">
                <Image
                  className="lazyload"
                  data-src="/images/section/mobile-app-01.webp"
                  alt=""
                  src="/images/section/mobile-app-01.webp"
                  width={469}
                  height={893}
                />
              </div>
              <div className="img2">
                <Image
                  className="lazyload"
                  data-src="/images/section/mobile-app-02.webp"
                  alt=""
                  src="/images/section/mobile-app-02.webp"
                  width={422}
                  height={793}
                />
              </div>
