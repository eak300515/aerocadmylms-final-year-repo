          ...
          <div className="row">
            <div className="col-lg-8">
              <div className="content">
                ...
                <p className="except">
                  Learn: Drone Mechanics | UAV Navigation | Aerial Mapping |
                  Remote Sensing | Flight Safety | Ground Control Systems |
              ...
              <div className="sidebar-course course-single-v1">
                ...
                <div className="sidebar-course-content">
                  <div className="course-price">
                    <div className="price">
                      <h3 className="fw-5">Rs. 2490.00</h3>
                      <h6 className="fs-15">Rs. 4490.00</h6>
                    </div>
